...
class KodoModel(KodoTemplate):
    ...
    def create_generator(self):
        ...
        control_pred = Dense(self.num_control_outputs, activation="softsign")(g)
    ...
    def create_model(self, batch_size=1):
        ...
        self.control_generator=generator
    ...
    def get_actions(self, img):
        ...
        out = self.control_generator.predict([np.expand_dims(img, axis=0), noise])[0]
        return out
